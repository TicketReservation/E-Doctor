                            ...
                            <tbody>
                              <tr>
                               <th>{user.FirstName}</th>&nbsp;&nbsp;&nbsp;&nbsp;
                                <th>{user.Email}</th>&nbsp;&nbsp;&nbsp;&nbsp;
                                <th>{user.UserType}</th>
                                <th><BanButton onClick={() => handleBanDoctor(user.Email)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
