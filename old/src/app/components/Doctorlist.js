    ...
    return (
        <div>
           <div style={{
            ...
            <p style={{ marginBottom:'200px', color: '#8492A6', fontSize: '16px' }}>Please enter the doctor name to find the best doctor for </p>
                    </div>
          </div>
...
/>  
        ...
        <div style={{ padding: '20px', borderRadius: '10px', margin: 'auto', marginTop: '50px' }}>
      <Image
