...
function Doctor() {
  ...
  //     img: {src:"https://doctris-landing-next.vercel.app/_next/image?url=%2Fimages%2Fdoctors%2F02.jpg&w=3840&q=75",width: "100px",height: "100px"},
  //   },
  //   {
  //     FirstName: "Michael",
  //     LastName: "Johnson",
  ...
  //     img: {src:"https://doctris-landing-next.vercel.app/_next/image?url=%2Fimages%2Fdoctors%2F03.jpg&w=3840&q=75",width: "100px",height: "100px"},
  //   },
  //   {
  //     FirstName: "Sarah",
  //     LastName: "Brown",
        ...
        >
          <div style={{ marginTop: "150px" }}>
            ...
            >
              ...
              >
                Please enter the doctor name to find the best doctor for{" "}
              </p>
            </div>
          </div>
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <ul className="list-unstyled mt-2 mb-0">
                    ...
                    <Link href={'/chat'} legacyBehavior>  <button className="btn btn-icon btn-pills btn-soft-primary">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="icons"
                          fill="none"
                    ...
                    <li className="mt-2 list-inline-item">
                     <Link href={'/doctorRates'} legacyBehavior> <button className="btn btn-icon btn-pills btn-soft-primary"
